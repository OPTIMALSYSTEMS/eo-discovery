 ...
 * You must 'npm install xlsx' before you can run this excample by running 'node example/excel.js'.
 *
 * If the service is registered withing the registry, every one can call 'POST /ExcelReader' with a excel
